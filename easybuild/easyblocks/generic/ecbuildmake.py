...
##
"""
EasyBuild support for software that is configured with ecbuild, implemented as an easyblock
Based on CMakeMake easyblock

@author: Olivier Marsden, ECMWF
"""
import os
...
DEFAULT_CONFIGURE_CMD = 'ecbuild --log=DEBUG --build=DEBUG'
DEFAULT_MAKE_CMD = 'make VERBOSE=1 '
...
class EcbuildMake(ConfigureMake):
    """Support for configuring build with ecbuild instead of traditional configure script"""
    ...
    def __init__(self, *args, **kwargs):
        """Constructor for EcbuildMake easyblock"""
        super(EcbuildMake, self).__init__(*args, **kwargs)
        self._lib_ext = None
    ...
    def configure_step(self, srcdir=None, builddir=None):
        ...
        #options = ['--prefix=%s ' % self.installdir]
        options = []
        options.append("-DCMAKE_INSTALL_PREFIX=%s " % self.installdir)
    ...
    def test_step(self):
        ...
        super(EcbuildMake, self).test_step()
